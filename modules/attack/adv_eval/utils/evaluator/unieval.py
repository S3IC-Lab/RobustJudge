...
def convert_to_json(output_list, src_list=None, ref_list=None, scores=None, doc_id=None, system_id=None):
    """
...
def add_question(dimension, output, src=None, ref=None, task=None):
    """
...
class SumEvaluator(Evaluator):
    def __init__(self, args):
        ...
        self.scorer = UniEvaluator(model_name_or_path='MingZhong/unieval-sum',
                                   max_length=1024,
                                   device='cuda:0', cache_dir='./cache')
        self.task = 'summarization'
        # self.dimensions = ['coherence', 'consistency', 'fluency', 'relevance']
        # only evaluate the consistency/factual
        self.dimensions = ['consistency']

    def get_name(self):
        return 'unieval'

    def get_score(self, context, response, ground_truth, context2=None):
        data = convert_to_json(output_list=[response], src_list=[context], ref_list=[ground_truth])
        scores = self.evaluate(data)
        return scores[0]['overall'] * 100
...
class DialogEvaluator(Evaluator):
    def __init__(self, args):
        ...
        # use coherence score only
        self.dimensions = ['coherence']
        # self.dimensions = ['naturalness', 'coherence', 'understandability']
