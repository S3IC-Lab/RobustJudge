...
class SummarizationEmptyAttack(SummarizationPlain):
    def __init__(self,benchmark_evaluator,attack_instance, target_instance,args):
        super(SummarizationEmptyAttack, self).__init__(benchmark_evaluator,attack_instance, target_instance,args)
...
class CodeEmptyAttack(CodePlain):
    def __init__(self,benchmark_evaluator,attack_instance, target_instance,args):
        super(CodeEmptyAttack, self).__init__(benchmark_evaluator,attack_instance, target_instance,args)
...
class MathEmptyAttack(MathPlain):
    def __init__(self,benchmark_evaluator,attack_instance, target_instance,args):
        super(MathEmptyAttack, self).__init__(benchmark_evaluator,attack_instance, target_instance,args)
...
class KnowledgeEmptyAttack(KnowledgePlain):
    def __init__(self,benchmark_evaluator,attack_instance, target_instance,args):
        super(KnowledgeEmptyAttack, self).__init__(benchmark_evaluator,attack_instance, target_instance,args)
...
class TranslationEmptyAttack(JudgeAttacker):
    def __init__(self,benchmark_evaluator,attack_instance, target_instance,args):
        self.result = None
