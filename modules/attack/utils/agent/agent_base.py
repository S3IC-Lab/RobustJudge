...
support_models = ['gpt-3.5-turbo', 'gpt-3.5-turbo-0301', 'gpt-4', 'gpt-4-0314', 'gpt-4o-2024-08-06', 'gpt-4o','gpt-4o-2024-11-20']
...
class Agent:
    ...
    @backoff.on_exception(backoff.expo, (RateLimitError, APIError, APIConnectionError), max_tries=40)
